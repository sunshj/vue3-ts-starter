export function isUserName(_rule: any, value: string, callback: Function) {
...
export function isPassword(_rule: any, value: string, callback: Function) {
...
export function isEmail(_rule: any, value: string, callback: Function) {
